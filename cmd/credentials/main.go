...
func main() {
	...
	case "edit":
		...
		// command = &credentials.CommandRunner{}
		editor := credentials.NewConfigEditor(configDir, credentialsFile, masterKeyFile, editor, executor)
		if err := editor.OpenWithCommandExecutor(); err != nil {
